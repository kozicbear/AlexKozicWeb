...
export const EXPERIENCES = [
  {
    ...
    description:`- Shape the culture of residential life staff by directly overseeing and mentoring 6 other members of staff with a 95% satisfaction rate
  ...
  },
  {
    ...
    company:"Foreflight",
    description:`- Upgraded ForeFlights internal tooling from a dated desktop application to a modern web application using TypeScript and React, expediting internal teams ability to find and scrub NOTAMs (Notices to Airmen), a mission-critical product
  ...
  },
  {
    ...
    description:`- Forecasted structured trades fund profitability by building a cash flow model in excel providing marketing insights
  ...
  },
  {
    ...
    description:`- Worked as a part time ski instructor during the winters for beginner to intermediate level skiers.`
  },
];